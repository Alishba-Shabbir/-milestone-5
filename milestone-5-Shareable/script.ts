...
// const usname = (document.getElementById('name') as HTMLInputElement).value;
...
//             if (nameInput) nameInput.value = resumeData.name || '';
//             if (emailInput) emailInput.value = resumeData.email || '';
//             if (phoneInput) phoneInput.value = resumeData.phone || '';
//             if (educationInput) educationInput.value = resumeData.education || '';
//             if (experienceInput) experienceInput.value = resumeData.experience || '';
//             if (skillsInput) skillsInput.value = resumeData.skills || '';
//         }
//     }
// });
